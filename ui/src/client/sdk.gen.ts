 ...
 */
export const updateAssetCommentByAssetAndCommentId = <ThrowOnError extends boolean = false>(options: Options<UpdateAssetCommentByAssetAndCommentIdData, ThrowOnError>): RequestResult<UpdateAssetCommentByAssetAndCommentIdResponses, UpdateAssetCommentByAssetAndCommentIdErrors, ThrowOnError> => (options.client ?? client).put<UpdateAssetCommentByAssetAndCommentIdResponses, UpdateAssetCommentByAssetAndCommentIdErrors, ThrowOnError>({
 ...
 */
export const listAssetCommentsByAssetId = <ThrowOnError extends boolean = false>(options: Options<ListAssetCommentsByAssetIdData, ThrowOnError>): RequestResult<ListAssetCommentsByAssetIdResponses, ListAssetCommentsByAssetIdErrors, ThrowOnError> => (options.client ?? client).get<ListAssetCommentsByAssetIdResponses, ListAssetCommentsByAssetIdErrors, ThrowOnError>({ url: '/assets/{id}/comments', ...options });

/**
 * Add a comment to the specified asset.
 */
export const createAssetCommentByAssetId = <ThrowOnError extends boolean = false>(options: Options<CreateAssetCommentByAssetIdData, ThrowOnError>): RequestResult<CreateAssetCommentByAssetIdResponses, CreateAssetCommentByAssetIdErrors, ThrowOnError> => (options.client ?? client).post<CreateAssetCommentByAssetIdResponses, CreateAssetCommentByAssetIdErrors, ThrowOnError>({
...
export const getAssetTimelineById = <ThrowOnError extends boolean = false>(options: Options<GetAssetTimelineByIdData, ThrowOnError>): RequestResult<GetAssetTimelineByIdResponses, GetAssetTimelineByIdErrors, ThrowOnError> => (options.client ?? client).get<GetAssetTimelineByIdResponses, GetAssetTimelineByIdErrors, ThrowOnError>({ url: '/assets/{id}/timeline', ...options });
