 ...
 */
export const getContactDetails = <ThrowOnError extends boolean = false>(options?: Options<GetContactDetailsData, ThrowOnError>): RequestResult<GetContactDetailsResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetContactDetailsResponses, unknown, ThrowOnError>({ url: '/contact', ...options });
