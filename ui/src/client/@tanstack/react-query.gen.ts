 ...
 */
export const getContactDetailsOptions = (options?: Options<GetContactDetailsData>) => queryOptions<GetContactDetailsResponse, DefaultError, GetContactDetailsResponse, ReturnType<typeof getContactDetailsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
